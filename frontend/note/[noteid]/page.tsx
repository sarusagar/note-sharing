...
<div className="py-16">
    <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        ...
        <Image src={note?.file as string} alt={note?.subtitle as string} width={200} height={300} />
            <h2 className="text-2xl font-semibold text-gray-700 text-center">{note?.title}</h2>
            <p className="text-xl text-gray-600 text-center">{note?.subtitle}</p>
            <a href="#" className="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                ...
                <h1 className="px-4 py-3 w-5/6 text-center text-gray-600 font-bold">{note?.description}</h1>
            </a>
